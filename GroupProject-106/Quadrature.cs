...
namespace GroupProject_106
{
    internal class Quadrature
    {
        ...
        public double __restart(Function func, double x0, double x1, int nseg0, bool reset_calls = true)
        {
        ...
        public double __double_nseg(Function func, double x0, double x1)
        ...
        public double romberg(Function func, double x0, double x1, double rtol = 1e-10, int nseg0 = 1, int maxcol = 5, bool reset_calls = true)
        {
            ...
            Itable.Add(new List<double> { __restart(func, x0, x1, nseg0, reset_calls) });
            //ListPrint(Itable);
            int i = 0;
            ...
            while (error_est > Math.Abs(rtol * ans))
            {
                ...
                for (int z = 0; z < ans_col + 1; z++)
                    Itable[^1].Add(__double_nseg(func, x0, x1));
                //------------------------------------------------------
